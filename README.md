...
building a React dashboard, training a classifier, filtering a signal — these
...
| | |
|---|---|
| **Embedded** | C++ on STM32, FreeRTOS, Zephyr, LVGL interfaces, drivers written from datasheets, MISRA C++, serial protocols with CRC |
| **Web and backend** | TypeScript, React, Django REST, Flask, PostgreSQL, SQLite, JWT authentication |
| **Data** | TensorFlow and PyTorch, transfer learning, InfluxDB time series, digital signal processing in MATLAB |
| **Infrastructure** | Linux, Docker, Ansible, systemd, embedded Linux on Toradex, CI pipelines |
...
Currently specializing in Data Science & Analytics.
